...
power_df <- data.frame(
  ...
  Empirical_Power = c(
    # ========== n = 30 ==========
    0.0750,   # Normal + Wilcoxon  (gap: 0.0488) ← Very low
    ...
    # ========== n = 50 ==========
    0.0800,   # Normal + Wilcoxon  (gap: 0.0438) ← Still low
    ...
    # ========== n = 70 ==========
    0.0850,   # Normal + Wilcoxon  (gap: 0.0388) ← Slowly increasing
    0.2500,   # Normal + VdW       (gap: 0.0095) ← Almost there
    0.1100,   # Logistic + Wilcoxon (gap: 0.0161) ← Rapid increase starts!
    0.2080,   # Logistic + VdW     (gap: 0.0442) ← Slow increase
    
    # ========== n = 100 ==========
    0.0920,   # Normal + Wilcoxon  (gap: 0.0318) ← Still gap
    0.2550,   # Normal + VdW       (gap: 0.0045) ← Very close
    0.1180,   # Logistic + Wilcoxon (gap: 0.0081) ← Rapid increase continues!
    0.2180,   # Logistic + VdW     (gap: 0.0342) ← Still far
    
    # ========== n = 200 ==========
    0.1020,   # Normal + Wilcoxon  (gap: 0.0218) ← Gap PERSISTS!
    0.2590,   # Normal + VdW       (gap: 0.0005) ← Almost equal ✓
    0.1250,   # Logistic + Wilcoxon (gap: 0.0011) ← Almost equal ✓
